...
// FIX: este ficheiro tinha o conteúdo do [id]/route.ts (PATCH/DELETE).
// Conteúdo correcto: GET (lista) + POST (cria)
...
export async function POST(
  ...
  try {
    ...
    // time e status: inseridos com COALESCE — se a coluna não existir ainda
    // (antes da migration), o Postgres ignora o valor extra.
