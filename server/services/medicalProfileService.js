...
// FIX: peso (weight_kg) nunca era lido, gravado, nem devolvido — nem no
// fromRow, nem no INSERT/UPDATE. Coluna já garantida pela migration
// 004_medical_profile_weight.sql.
function fromRow(r) {
...
function buildDefault(petId) {
  return { petId, sex: 'unknown', neutered: null, neuteredAge: null, bloodType: null,
    allergies: [], conditions: [], surgeries: [], environment: null,
    livingWithAnimals: null, behavioralNotes: null, vetQuestions: null,
    weightKg: null, updatedAt: null }
}
    ...
    const [row] = await sql`
      INSERT INTO medical_profiles
        (pet_id, sex, neutered, neutered_age, blood_type, allergies, conditions, surgeries,
         environment, living_with_animals, behavioral_notes, vet_questions, weight_kg, updated_at)
      VALUES
