...
const visiblePets = selPet === 'all'
  ? petsMeta
  : petsMeta.filter(p => p.id === selPet)
...
<AddCareModal
  ...
  defaultPetId={selPet !== 'all' ? selPet : pets[0]?.id}
  onAdd={d => {
    addCare({
      petId: d.petId,
      emoji: d.emoji,
